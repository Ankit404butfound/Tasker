...
public class View_wrok_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (scheduled_date != null) {
            ...
            if (mnth < 10){
                sch_mnth = "0"+scheduled_date;
            }
            Log.d("Loggingg", sch_mnth);
            ...
            scheduled_date_view.setText(String.format("Scheduled for: %s-%s-%s %s:%s:00", yr, mnth, dy, hr, mn));
        }

        Button back = findViewById(R.id.back);
        back.setOnClickListener(v -> {
//            if (text_updated) {
//                Intent intent = new Intent(View_wrok_activity.this, MainActivity.class);
...
//            }
        ...
        mark_done.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        switch (which){
                            case DialogInterface.BUTTON_POSITIVE:
                                db.mark_task_as_done(id);
                                Toast.makeText(View_wrok_activity.this, "Task marked as DONE", Toast.LENGTH_LONG).show();
                                Intent intent = new Intent(View_wrok_activity.this, MainActivity.class);
                                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                startActivity(intent);
                                break;
                ...
                AlertDialog.Builder ab = new AlertDialog.Builder(View_wrok_activity.this);
                ab.setMessage("Mark this task as DONE?").setPositiveButton("Yes", dialogClickListener)
                ...
                DialogInterface.OnClickListener dialogClickListener = new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        switch (which){
                            case DialogInterface.BUTTON_POSITIVE:
                                db.delete_task(id);
                                Toast.makeText(View_wrok_activity.this, "Task deleted", Toast.LENGTH_LONG).show();
                                Intent intent = new Intent(View_wrok_activity.this, MainActivity.class);
                                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                startActivity(intent);
                                break;
        ...
        save.setOnClickListener(v -> {
            ...
            Toast.makeText(View_wrok_activity.this, "Task updated", Toast.LENGTH_LONG).show();
        });
    }
}